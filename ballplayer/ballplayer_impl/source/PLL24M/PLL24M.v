...
/* Module Version: 5.7 */
/* E:\software\Diamond\ispfpga\bin\nt64\scuba.exe -w -n PLL24M -lang verilog -synth lse -arch xo2c00 -type pll -fin 12 -fclkop 24 -fclkop_tol 0.1 -trimp 0 -phasep 0 -trimp_r -phase_cntl STATIC -fb_mode 1  */
/* Sun Feb 16 18:00:26 2025 */


`timescale 1 ns / 1 ps
module PLL24M (CLKI, CLKOP)/* synthesis NGD_DRC_MASK=1 */;
    input wire CLKI;
    output wire CLKOP;
